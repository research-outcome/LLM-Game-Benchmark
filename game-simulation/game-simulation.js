...
const OPENAI_API_KEY = "PLACE-YOUR-OPENAI_API_KEY";
const GOOGLE_API_KEY = "PLACE-YOUR-GOOGLE_API_KEY";
const BEDROCK_SECRET = "PLACE-YOUR-BEDROCK_SECRET";
const BEDROCK_URL = "PLACE-YOUR-AWS-BEDROCK-URL";
