...
export class ConnectFour {
    ...
    static moveRequirements() {
        return " The move given by the suggester must be in the following JSON format: {'column': ColumnNumber}. ColumnNumber should be replaced with an actual number. The move must also conform to the ColumnNumber range: ColumnNumber starts at 1 (the leftmost column is {'column': 1}). The maximum value for ColumnNumber is 7, as the grid is 7 columns wide. Finally, the move's location must not already be occupied by another move. \n";
    }
